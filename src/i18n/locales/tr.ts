...
export default {
  ...
  auth: {
    ...
    pinSetupTitle: 'PIN Oluşturun',
    pinSetupSubtitle: 'Uygulamaya girmek için 4-6 haneli bir PIN belirleyin',
    pinEntryTitle: 'PIN Giriniz',
    pinEntrySubtitle: 'Devam etmek için PIN kodunuzu girin',
